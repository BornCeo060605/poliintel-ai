...
export default function SignUpPage() {
  ...
  const [role, setRole] = useState<'consultant' | 'politician'>('consultant');
            ...
            <div className="flex gap-4">
              ...
              <label className="flex cursor-pointer items-center gap-2">
                <input
                  ...
                  name="role"
                  value="politician"
                  checked={role === 'politician'}
                  onChange={() => setRole('politician')}
                  className="text-blue-600"
                />
                <span className="text-sm text-gray-700">Politician</span>
              </label>
            </div>
          </div>
